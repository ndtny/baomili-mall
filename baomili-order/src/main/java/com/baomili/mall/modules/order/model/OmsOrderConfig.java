...
@TableName("oms_order_config")
@ApiModel(value="OmsOrderConfig对象", description="订单配置表")
public class OmsOrderConfig implements Serializable {
    ...
    private Integer killOrderOvertime;
